...
import { ARTIFACTS_ROUTE, CALLS_ROUTE, contributedRoutes, MESSAGING_ROUTE, ROUTES_AREA, SKILLS_ROUTE } from '../routes'
...
const CallsView = lazy(async () => ({ default: (await import('../calls')).CallsView }))
...
const BUILTIN_PAGES: Record<string, { render: () => ReactNode; title: string }> = {
  ...
  [CALLS_ROUTE]: { render: () => <CallsView />, title: 'LLM calls' },
