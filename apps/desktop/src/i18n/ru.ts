...
export const ru = defineLocale({
  ...
  shell: {
    ...
    statusbar: {
      ...
      toggleSessionCost: 'Расход за сеанс',
      ...
      sessionCostTitle: 'Оценка расходов за сеанс по прайсу провайдера (OpenRouter — оценка до сверки); токены из кэша считаются по цене cache-read',
