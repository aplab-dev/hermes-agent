...
export const en: Translations = {
  ...
  shell: {
    ...
    statusbar: {
      ...
      sessionCostTitle: 'Estimated spend this session — provider list prices (OpenRouter: estimated until reconciled); cached tokens are billed at the cache-read rate',
